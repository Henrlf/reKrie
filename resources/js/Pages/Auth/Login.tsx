                ...
                <div className="flex flex-col items-center justify-center mt-5">
                    ...
                    {canResetPassword && (
                        <Link
                            ...
                            className="mt-2 underline text-sm text-gray-600 hover:text-gray-900 rounded-md text-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                            Esqueceu sua senha?
                        </Link>
                    )}
                    ...
                    <div className="mt-5 underline text-sm text-gray-600 hover:text-gray-900 rounded-md text-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        <Link
                            href={route('register')}
