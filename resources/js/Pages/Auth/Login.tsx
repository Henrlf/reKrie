...
export default function Login({status, canResetPassword}: { status?: string, canResetPassword: boolean }) {
    ...
    return (
        <GuestLayout user={undefined}>
            ...
            <div className="w-full sm:max-w-md px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg" style={{"marginTop": "25vh"}}>
                <div className="flex items-center justify-center">
                    <span className="ml-2 text-xl text-black">Faça seu login</span>
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="flex flex-col items-center justify-center mt-4">
                        ...
                        {/*{canResetPassword && (*/}
                        {/*    <Link href={route('password.request')} className="mt-4 underline text-sm text-gray-600 hover:text-gray-900 rounded-md text-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">*/}
                        {/*        Esqueceu sua senha?*/}
                        {/*    </Link>*/}
                        {/*)}*/}
